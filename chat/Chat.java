...
//	}
	...
	private void connect(String[] args) {
		if(args != null && args.length == 3) {
			...
			System.out.println("Command connect is missing 1 or more arguments -- > connect <destination ip> <destination port>");
		}
	}
	...
	public void beginChat() {
		...
		try {
			String mainip = getAddress();
//			this.mainIP = getAddress();//
